...
namespace MobileWaterShaderEKV
{
    ...
    public class WaterControl_EKV : MonoBehaviour
    {
        ...
        void SetColor()
        {
            ...
            _renderer.sharedMaterial.color = new Color(r, g, b, a);
        }
        ...
        void SetMain()
        {
            ...
            _renderer.sharedMaterial.mainTextureOffset = new Vector2(offsetX, offsetY);
        }
        void SetDiff()
        {
            ...
            string[] mats = _renderer.sharedMaterial.GetTexturePropertyNames();
            ...
            foreach (var mat in mats)
            {
                if (mat == texturePropertyName)
                    _renderer.sharedMaterial.SetTextureOffset(texturePropertyName, new Vector2(offsetX, offsetY));
            }
        }
